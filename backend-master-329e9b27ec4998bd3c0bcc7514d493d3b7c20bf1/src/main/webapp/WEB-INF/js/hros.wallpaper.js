	...
	return {
		...
		*/
		get : function(callback){
			HROS.CONFIG.wallpaperType = 'juzhong';
			HROS.CONFIG.wallpaper = '../images/wallpaper/loading_ernv.jpg';
			HROS.CONFIG.wallpaperState = '2';
			callback && callback();
			...
			switch(HROS.CONFIG.wallpaperState){
				...
				case '2':
					switch(HROS.CONFIG.wallpaperType){
						...
						case 'juzhong':
							if(isreload){
								$('body').append('<div id="zoomWallpaperGrid" style="position:absolute;z-index:-10;top:0;left:0;height:100%;width:100%;background: #000000 url(' + HROS.CONFIG.wallpaper + ') no-repeat 50% 50%"></div>');
							}
							break;
						//填充
						case 'tianchong':
