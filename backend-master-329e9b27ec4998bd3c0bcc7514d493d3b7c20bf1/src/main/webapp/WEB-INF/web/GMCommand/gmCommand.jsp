...
<div class="ui-layout-center">
    <div class="tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li class="">
                <a data-toggle="tab" href="#history"><spring:message code='gccp.gm.list'/></a>
            </li>
        </ul>
        <div class="tab-content">
                        ...
                        <div class="control-group ">
                            ...
                            <div class="controls">
                                <select id="s3" name="command">
                                    ...
                                    <option value="3"><spring:message code='gccp.gm.setGm.desc'/></option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
            ...
            <div id="history" class="tab-pane fade in">
                <h5><spring:message code='gccp.gm.history.desc'/></h5>
                <div class="well">
                    <s:form id="historyForm" enctype="multipart/form-data" cssClass="form-horizontal">
                        <div class="control-group ">
                    ...
                    <button id="historyQuery" style="margin-left:180px;" class="btn btn-primary"><spring:message
...
<script>
    $("#action").click(function () {
        ...
        if (servers.length == 0) {
            ...
            bootstrapConfirm("<spring:message code='gccp.gm.confirm'/>", function () {
                $.post("actionGMCommand", $("#GMForm").serialize() + serverToParamBySelect(servers), function (data) {
    ...
    $("#historyQuery").click(function () {
        $.post("actionHistory", $("#historyForm").serialize(), function (data) {
            if (data.message != "") {
                bootstrapAlert(data.message);
            } else {
                var title = ["<spring:message code='gccp.common.platformServer' />",
                    "<spring:message code='gccp.gm.actor'/>",
                    "<spring:message code='gccp.gm.command'/>",
                    "<spring:message code='gccp.gm.time'/>",
                    "<spring:message code='gccp.gm.result'/>"];
                var column = ["platformServer", "sendUser", "command", "sendDate", "result"];
                var table = createTable(data.gmInfo, title, column);
