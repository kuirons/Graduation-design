...
<script type="text/javascript">
    ...
    $(".btn-info").die().live("click", function () {
        var id = $(this).val();
        $.get("editUser?userId=" + id, function (data) {
            $("#myModal").html(data);
            $('#myModal').modal({
                backdrop: 'static'
            });
