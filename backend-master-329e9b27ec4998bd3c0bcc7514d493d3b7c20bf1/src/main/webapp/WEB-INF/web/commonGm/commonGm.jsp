...
<div class="ui-layout-center">
    <div class="tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li class="">
                <a data-toggle="tab" href="#commonGmMail"><spring:message code='gccp.gm.mail.multiTitle'/></a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#commonGmNote"><spring:message code='gccp.gm.note.shortTitle'/></a>
            </li>
        </ul>
        <div class="tab-content">
            ...
            <div id="commonGmMail" class="tab-pane fade in">
                ...
                <div class="well">
                    ...
                    <button id="mailAction" style="margin-left:180px;" class="btn btn-primary"><spring:message
                            code="gccp.common.start"/></button>
                </div>
                <div class="row-fluid">
            ...
            <div id="commonGmNote" class="tab-pane fade in">
                <h5><spring:message code='gccp.gm.note.desc'/></h5>
                <div class="well">
                    <s:form id="commonGmNoteForm" enctype="multipart/form-data" cssClass="form-horizontal">
                        <div class="control-group ">
                            ...
                            <div class="controls">
                                <div class="input-append date form_datetime endDateTimePicker">
                                    <input type="text" id="startTime" name="startTime" value="0"
                                           title="<spring:message code='gccp.gm.startTime.tips'/>"/>
					                <span class="add-on">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="noteInterval" name="interval" value="0"
                                       title="<spring:message code='gccp.gm.interval.tips'/>"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label"><spring:message code='gccp.gm.note.times'/>:</label>
                            <div class="controls">
                                <input type="text" id="noteTimes" name="times" value="1"/>
                            </div>
                        </div>
                        <div class="control-group">
                    ...
                    <button id="noteAction" style="margin-left:180px;" class="btn btn-primary"><spring:message
                            code="gccp.common.start"/></button>
                </div>
                <div class="row-fluid">
...
<script>
    ...
    $("#noteAction").click(function () {
        ...
        if (servers.length == 0) {
            ...
            bootstrapConfirm("<spring:message code='gccp.gm.confirm'/>", function () {
                $.post("sendNote", $("#commonGmNoteForm").serialize() + serverToParamBySelect(servers), function (data) {
                    if (data.errorMessage != "") {
                        bootstrapAlert(data.errorMessage);
                    } else {
